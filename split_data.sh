...
cp dsv05_new_gl.seq dsv05_new_sorted.seq
...
perl -ne 'print if !$a{$_}++' dsv05_new_sorted.seq2 > dsv05_new_sorted.seq
...
catmandu convert MARC --type ALEPHSEQ to MARC --type XML --pretty 1 --fix split_data_rest2.fix < dsv05_new_sorted.seq > dsv05_rest2.xml
